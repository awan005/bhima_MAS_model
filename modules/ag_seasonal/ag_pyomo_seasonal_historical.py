...
def ag_optimization_historical(input_df,solar_land):
    print()
    print('Starting Ag Optimization Run historical ++++')
    tic()
    ...
    df_net_revenue = input_df['net_revenue_2015'] # pd.read_excel(filepath, sheet_name="net_revenue")
    dict_net_revenue = {}
