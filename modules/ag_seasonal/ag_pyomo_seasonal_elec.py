...
def ag_optimization_elec(input_df):
    print()
    print('Starting Ag Optimization Run elecprice ++++')
    tic()
    ...
    model.gw_cost_p = Param(initialize=0.32, doc='groundwater water cost (billion USD per m per km3)')
